...
packer build -var base_image=ubuntu:trusty -var output_repository=omnibus/ubuntu -var output_tag=trusty ubuntu-packer.json
docker pull debian:wheezy
packer build -var base_image=debian:wheezy -var output_repository=omnibus/debian -var output_tag=wheezy ubuntu-packer.json
